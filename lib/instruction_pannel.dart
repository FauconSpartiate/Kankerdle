...
class DecoratedTitleWidget extends StatelessWidget {
  const DecoratedTitleWidget({required this.title, super.key});
...
class DecoratedPlainText extends StatelessWidget {
  const DecoratedPlainText({required this.text, super.key});
...
class DecoratedTextBox extends StatelessWidget {
  const DecoratedTextBox({required this.letter, required this.state, super.key});
                  ...
                  child: Container(
                    ...
                    child: const SingleChildScrollView(
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        DecoratedPlainText(
                          text: "The aim of the Kankerdle game is to guess a word within six tries.",
                        ),
